...
process = mainOsc(noteTrig : rdm(72,94) : mtof , noteTrig) * envWrapper(noteTrig, ampEnv, amp_xp(2510)) <: _,_, (rdmPanner : panSte) : panConnect : *,* : zita_rev1;

// BIRD TRIGGER

noteTrig = button("noteTrig");
