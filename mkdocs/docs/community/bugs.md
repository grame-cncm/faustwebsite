...
The best way to report a bug in Faust or in any of its associated tool is to submit an issue on the corresponding Git repository:
...
* [Report a bug in the **Faust Web IDE**](https://github.com/grame-cncm/faustide/issues)
