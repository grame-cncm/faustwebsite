...
There are many ways to get started with Faust:

- If you have an hour or two to spare, read our [Quick Start](https://faustdoc.grame.fr/manual/quick-start/) Tutorial (recommended option).
- If you're in a hurry, check out our [Online Examples](https://faustdoc.grame.fr/examples/ambisonics/).
- If you wanna do things the right way, read the [Faust Manual](https://faustdoc.grame.fr/manual/introduction/).
- If you prefer videos, you can watch [the Faust Kadenze course](https://www.kadenze.com/courses/real-time-audio-signal-processing-in-faust/info)
