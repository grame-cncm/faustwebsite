...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodeClarinet()));
	faust.Clarinet_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
