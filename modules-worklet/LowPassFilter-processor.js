...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodeLowPassFilter()));
	faust.LowPassFilter_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
