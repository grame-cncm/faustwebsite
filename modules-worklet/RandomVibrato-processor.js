...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodeRandomVibrato()));
	faust.RandomVibrato_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
