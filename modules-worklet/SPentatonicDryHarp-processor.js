...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodeSPentatonicDryHarp()));
	faust.SPentatonicDryHarp_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
