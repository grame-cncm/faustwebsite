...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodePhaser()));
	faust.Phaser_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
