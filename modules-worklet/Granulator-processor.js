...
class GranulatorProcessor extends AudioWorkletProcessor {
    ...
    static get parameterDescriptors () {
        ...
        faust.parse_ui(JSON.parse(getJSONGranulator()).ui, params, faust.parse_item1);
