...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodeGranulator()));
	faust.Granulator_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
