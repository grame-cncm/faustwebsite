...
class SNoiseburstProcessor extends AudioWorkletProcessor {
    ...
    constructor(options)
    {
        ...
        this.factory = SNoiseburstProcessor.SNoiseburst_instance.exports;
        this.HEAP = SNoiseburstProcessor.SNoiseburst_instance.exports.memory.buffer;
...
try {
    let wasm_module = new WebAssembly.Module(SNoiseburstProcessor.atob(getBase64CodeSNoiseburst()));
    SNoiseburstProcessor.SNoiseburst_instance = new WebAssembly.Instance(wasm_module, SNoiseburstProcessor.importObject);
