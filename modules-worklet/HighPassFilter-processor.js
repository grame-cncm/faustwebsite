...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodeHighPassFilter()));
	faust.HighPassFilter_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
