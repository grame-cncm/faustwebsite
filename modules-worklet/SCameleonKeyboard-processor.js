...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodeSCameleonKeyboard()));
	faust.SCameleonKeyboard_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
