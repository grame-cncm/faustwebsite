...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodeSTibetanBowl()));
	faust.STibetanBowl_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
