...
class SModulation2Processor extends AudioWorkletProcessor {
    ...
    static get parameterDescriptors () {
        ...
        faust.parse_ui(JSON.parse(getJSONSModulation2()).ui, params, faust.parse_item1);
