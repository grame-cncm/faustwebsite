...
class ZitaReverbProcessor extends AudioWorkletProcessor {
    ...
    constructor(options)
    {
        ...
        this.factory = ZitaReverbProcessor.ZitaReverb_instance.exports;
        this.HEAP = ZitaReverbProcessor.ZitaReverb_instance.exports.memory.buffer;
...
try {
    let wasm_module = new WebAssembly.Module(ZitaReverbProcessor.atob(getBase64CodeZitaReverb()));
    ZitaReverbProcessor.ZitaReverb_instance = new WebAssembly.Instance(wasm_module, ZitaReverbProcessor.importObject);
