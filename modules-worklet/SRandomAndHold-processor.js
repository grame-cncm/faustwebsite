...
try {
	let wasm_module = new WebAssembly.Module(faust.atob(getBase64CodeSRandomAndHold()));
	faust.SRandomAndHold_instance = new WebAssembly.Instance(wasm_module, faust.importObject);
